...
# 데이터 로드 - 도로 중심선 좌표가 포함된 CSV 파일 로드
path_reference = pd.read_csv('/home/yumi/catkin_ws/src/my_msc_package/src/ref_long.csv', delimiter=',')
...
# 저장 경로 설정 (원본과 동일한 형식)
output_path = '/home/yumi/catkin_ws/src/my_msc_package/src/opt_long.csv'
