...
class Controller(object):
    def __init__(self,ref_path):
        ...
        self.paras_by_section = {
            "section_1": {"look_ahead_dist": 10, "kp":1.5, "kd": 0.2, "ki": 0.01},
            "section_2": {"look_ahead_dist": 10, "kp": 1.2, "kd": 0.2, "ki": 0.01},  # 50~99
            "section_3": {"look_ahead_dist": 10, "kp": 1.8, "kd": 0.4, "ki": 0.05},  # 100~149
        }
    def get_paras_for_section(self, idx):
        if 0<= idx < 318:
            return self.paras_by_section["sention_1"]
        elif 318 <= idx < 562:
            return self.paras_by_section["senction_2"]
        elif 562 <=idx < 1096:
            return self.paras_by_section["section_3"]
        else: 
