...
# CSV 파일 경로
road_file_path = '/home/yumi/catkin_ws/src/my_msc_package/src/reference_path_short.csv'  # 도로 시각화를 위한 파일
waypoint_file_path = '/home/yumi/catkin_ws/src/my_msc_package/src/shortest_path_final3.csv'  # 웨이포인트 시각화를 위한 파일
