...
class VehicleDataSaver:
    def __init__(self, save_path, save_interval=0.1):
        """
        Args:
...
def main():
    ...
    # 저장할 CSV 파일 경로 설정
    save_path = '/home/yumi/catkin_ws/src/my_msc_package/src/name.csv'

    # VehicleDataSaver 초기화 (0.1초 간격으로 저장)
    saver = VehicleDataSaver(save_path, save_interval=0.1)
